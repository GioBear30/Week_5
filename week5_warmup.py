...
monkey = 'abcdefghijklmnopqrstuvwxyz'
...
oscar_quote = "With freedom, books, flowers, and the moon, who could not be happy? - Oscar Wilde"
print("moontlight" in oscar_quote)
